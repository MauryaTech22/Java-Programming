public class practice_1 {
    ...
    public static int updateIthBit(int n, int i, int newBit){    //clear ith bit
//        if(newBit == 0){
...
//        }
    ...
    public static int clearIBit(int n , int i){  //clear I bit
        int bitMask = (~0)<<i;
        return n & bitMask;
    }
    ...
    public static int countSetBits(int n ){
        int count = 0;
        while(n > 0){
            if((n & 1)  !=0){ // check least significant LSB
             count++;
            }
            n = n>>1;
        }
